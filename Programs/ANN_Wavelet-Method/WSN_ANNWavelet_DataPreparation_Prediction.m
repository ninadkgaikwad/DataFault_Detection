function [ WSN_ANNWavelet_InputPredict_DataCell, WSN_ANNWavelet_TargetPredict_DataCell, SignalPrediction_Possibilty_YesNo ] = WSN_ANNWavelet_DataPreparation_Prediction( SensorDataMatrixLabelled_Cell, WindowSize, ContinuousWindow_YesNo, Wavelet_Level, Wavelet_Filter, FeatureEnergySignal_YesNo )
...
WSN_ANNWavelet_TargetPredict_DataCell=ANN_Wavelet_Features_Matrix_Cell;

% Intializing WSN_ANNWavelet_Input_DataCell

WSN_ANNWavelet_InputPredict_DataCell=cell(1,C3);

% Creating WSN_ANNWavelet_Input_DataCell

if (C3==1) % Only one Sensor in Group
    
    WSN_ANNWavelet_InputPredict_DataCell= ANN_Wavelet_Features_Matrix_Cell;  
...
elseif (C3>1) % There are more than one Sensors in the group
    ...
    for j=1:C3
       ...
       for i=1:C3
          ...
          WSN_ANNWavelet_InputPredict_DataCell(1,j)={WSN_ANNWavelet_Input_DataMatrix};

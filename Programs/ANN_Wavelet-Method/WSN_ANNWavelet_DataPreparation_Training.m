function [ WSN_ANNWavelet_InputTrain_DataCell, WSN_ANNWavelet_TargetTrain_DataCell, SignalPrediction_Possibilty_YesNo ] = WSN_ANNWavelet_DataPreparation_Training( SensorDataMatrixLabelled_Cell, SensorGroup, FaultyData_YesNo, WindowSize, ContinuousWindow_YesNo, Wavelet_Level, Wavelet_Filter, FeatureEnergySignal_YesNo )
...
% Initializing ANN_Wavelet_Features_Matrix_Cell
...
WSN_ANNWavelet_TargetTrain_DataCell=ANN_Wavelet_Features_Matrix_Cell;

% Intializing WSN_ANNWavelet_Input_DataCell

WSN_ANNWavelet_InputTrain_DataCell=cell(1,C3);

% Creating WSN_ANNWavelet_Input_DataCell

if (C3==1) % Only one Sensor in Group
    
    WSN_ANNWavelet_InputTrain_DataCell= ANN_Wavelet_Features_Matrix_Cell;  
...
elseif (C3>1) % There are more than one Sensors in the group
    ...
    for j=1:C3
       ...
       for i=1:C3
          ...
          WSN_ANNWavelet_InputTrain_DataCell(1,j)={WSN_ANNWavelet_Input_DataMatrix};
